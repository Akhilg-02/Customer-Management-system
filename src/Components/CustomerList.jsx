...
import { Box, Button, Card, Grid, IconButton, Typography,Paper, Tooltip } from "@mui/material";
        ...
        {customers.map((items, key) => {
          return (
            <Grid item xs={12} sm={6} md={6} lg={6} key={items.id}  >
              <Paper sx={{display:"flex",flexGrow:1,maxWidth:550, margin:"1rem",p:3}}>
                <Box>
                ...
                <Box sx={{height:"15vh",justifyContent:"flex-end",display:"flex",flexGrow:2,mt:-3}}>
